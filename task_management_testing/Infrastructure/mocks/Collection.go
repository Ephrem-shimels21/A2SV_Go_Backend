...
import (
	...
	"github.com/Ephrem-shimels/A2SV_Go_Backend/task_management_with_cleanArchitecture/Infrastructure"
...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (infrastructure.Cursor, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
	...
	var r0 infrastructure.Cursor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) (infrastructure.Cursor, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) infrastructure.Cursor); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(infrastructure.Cursor)
		}
	}
...
func (_m *Collection) FindOne(_a0 context.Context, _a1 interface{}) infrastructure.SingleResult {
	ret := _m.Called(_a0, _a1)
	...
	var r0 infrastructure.SingleResult
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) infrastructure.SingleResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(infrastructure.SingleResult)
		}
	}
